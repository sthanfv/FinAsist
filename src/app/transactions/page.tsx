...
export default function TransactionsPage() {
    ...
    const { setTransactions, updateTransaction, deleteTransaction } = useAppStore(
      (state) => ({
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
                    <DialogTrigger asChild>
                       <button className="group bg-white text-green-600 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 hover:rotate-12">
                    ...
                    <DialogContent>
                      <EnhancedTransactionForm onTransactionAdded={handleTransactionAdded} />
                    </DialogContent>
                  </Dialog>
                </div>
              </div>
                  ...
                  <div className="mb-6">
                   ...
                   {transactions.length === 0 ? (
                    <div className="text-center py-10 bg-card rounded-xl shadow-soft">
                        ...
                        <Button onClick={() => setIsAddModalOpen(true)}>Añadir tu primera transacción</Button>
                    </div>
                    ) : (
                    <TransactionTable 
